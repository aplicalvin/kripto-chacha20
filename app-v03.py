...
class CryptoApp:
    ...
    def create_scrollable_image(self, parent):
        ...
        canvas = tk.Canvas(container, bg="white", height=220)  # Tinggi area scroll
    ...
    def create_column(self, parent, title, col_index):
        ...
        # Image preview
        # img_label = tk.Label(frame, text="No Image", bg="#fafafa", height=14, relief=tk.GROOVE)
        # img_label.pack(fill=tk.X, padx=6, pady=10)
        ...
        # Metrics box
        metrics_box = scrolledtext.ScrolledText(frame, height=15, font=("Consolas", 10))
        metrics_box.pack(fill=tk.BOTH, expand=True, padx=6, pady=10)

        return {"img_lbl": img_label, "hist_frm": hist_frame, "txt": metrics_box}

    # ========================================================
    # SELURUH LOGIC DIBAWAH INI TIDAK DIUBAH SAMA SEKALI
    # ========================================================
